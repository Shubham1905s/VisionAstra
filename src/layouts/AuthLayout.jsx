...
export default function AuthLayout() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-brand-100 via-sky-50 to-slate-100 p-6">
      <div className="mx-auto max-w-3xl">
        <header className="mb-6 rounded-xl bg-white p-5 shadow-sm">
          <h1 className="text-2xl font-bold text-brand-900">VisionAstra Management System</h1>
          ...
          <nav className="mt-3 flex flex-wrap gap-4 text-sm">
            <Link className="text-brand-700 underline" to="/">Landing</Link>
